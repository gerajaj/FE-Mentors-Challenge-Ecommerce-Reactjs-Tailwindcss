...
const MainProduct = () => {
    return (
        <main className="grid grid-cols-1 gap-8 items-center px-auto mt-4 mx-auto md:min-h-[calc(100vh-88px)] md:container md:grid-cols-2 md:px-6 md:mt-6 md:items-start lg:items-center lg:min-h-0">
            <MainImages
