...
export default () => {
    return (
        <section className="container mx-auto px-4 grid gap-y-4 md:px-0">
            ...
            <div className="grid grid-cols-3 md:grid-cols-[1fr_2fr] md:gap-x-2 mb-2">
                <div className="col-span-3 bg-gray-200 pb-2 px-5 rounded-md flex items-baseline justify-between md:col-span-1 mb-2">
