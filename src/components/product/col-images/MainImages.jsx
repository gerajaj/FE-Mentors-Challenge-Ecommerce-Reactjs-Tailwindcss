                ...
                isOpenModal && (
                    <>
                        <ModalProduct
                            ...
                            className="z-50 hidden md:grid md:grid-cols-4 md:gap-4 md:absolute md:max-w-lg md:top-1/2 md:left-1/2  lg:max-w-lg md:-translate-y-1/2 md:-translate-x-1/2"
                            handleCloseModal={handleCloseModal}
                        />
                        <span className="z-40 fixed top-0 left-0 md:bg-black/50 h-full w-full m-0 p-0 md:backdrop-blur" onClick={handleCloseModal}></span>
                    </>
